...
%MPS Screenshot
\newcommand{\ms}[2]{\gr{#1}{#2}{0.24}\FloatBarrier}
...
\newcommand{\mpsid}[1]{\textbf{\texttt{#1}}}
...
\newcommand{\cppproblem}{\paragraph{C++ Problematic}}
\newcommand{\pcppsolution}{\paragraph{Implementation in \pcpp}}