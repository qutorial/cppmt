...
\ms{nonpolycasting}{Casting Example}

The \fig{nonpolycasting} demonstrates some of the introduced in \pcpp\ features related to class type conversions.
...
The \cc{as} construction returns \cc{0} at run-time when conversion fails. Thus a good programming style
