...
and enabling the new statement concsist of just inheritting it from the base statement concept, which exists in the language extended, \fig{LanguageModularity}.
