...
In the \rsec{modularlang} I describe the modular approach towards language engineering and extending, intensively
...
principles, which I conside to be of practical value in the \rsec{genprinciples}.
