...
The reference type itself is implemented rather straightforward and similar to the pointer type of \mbdr. It iherits the \mpsid{Type} 
...
%Limitations
Among limitations of this approach one can take as an example \cc{std::vectoor<bool>}. 
...
extracting a value from such a \cc{vector}.
...
As auto-completion works very effective in the projectional editor, the need in the \cc{using} directive does
