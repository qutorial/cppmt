...
There is also a special kind of \rgp{intention}, called ``error intensions''. They are not anyhow fundamentally different 
from the usual \rgp{intention}, except their special purpose to fix an error when one occur. Error \rgp{intention} are
